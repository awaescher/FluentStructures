...
namespace FluentStructures.Drawing
{
    public static class ColorExtensions
    {
        ...
        public static Color AddAlpha(this Color c, int value) => WithAlpha(c, a => a + value);
        ...
        public static Color AddRed(this Color c, int value) => WithRed(c, r => r + value);
        ...
        public static Color AddGreen(this Color c, int value) => c.WithGreen(g => g + value);
        ...
        public static Color AddBlue(this Color c, int value) => WithBlue(c, b => b + value);
    }
}